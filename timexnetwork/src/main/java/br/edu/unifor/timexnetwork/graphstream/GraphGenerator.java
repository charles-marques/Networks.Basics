package br.edu.unifor.timexnetwork.graphstream;
...
import br.edu.unifor.timexnetwork.Aresta;
...
public class GraphGenerator {
	...
	private static void loadGraphData() {
		String fileName = "/home/suporte/eclipse-workspace/Networks.Data.Engineering/timexnetwork/resource/od/Arestas.csv";
...
//		System.setProperty("org.graphstream.ui.renderer", "org.graphstream.ui.j2dviewer.J2DGraphRenderer");
		...
		// CARREGANDO VERTICES
		vertices.forEach(v -> graph.addNode(v.trim()));
		
		int parada = 0;
		for (Aresta aresta : arestas) {
			parada = parada + 1;
			graph.addEdge(aresta.toString(), aresta.getOrigin().trim(), aresta.getDestination().trim());
			System.out.println("Atual: " + parada + " - " + arestas.size());
		}
